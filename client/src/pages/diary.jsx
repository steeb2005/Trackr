...
function DiaryEntry({entryId, entryTitle, entryContent, entryDate, ondeleteDiaryEntry}){
    ...
    return(
        <div key={entryId} className="mb-8">
            ...
            <div 
                className={`entry hover:cursor-pointer bg-gray-200 hover:shadow-layout-primary hover:shadow-[3px_3px] duration-100 p-4 rounded-xl ${isExpanded ? 'shadow-layout-primary shadow-[3px_3px]' : ''}`}
...
function Diary(){
    ...
    return(
        <div className="m-0 p-0">
            ...
            <div className="main-container w-full h-screen overflow-auto px-5 pt-20">
