...
function Sidebar({isOpen, onClose}){  
    return (       
        <div className={`bg-[#097204] h-screen w-64 z-50 fixed top-0 left-0 transition duration-300 
            ...
            <div className='p-5'>
                ...
                <div className='menu'>
                    ...
                    <nav className='space-y-4 text-white text-2xl font-semibold mt-10'> 
                        <span className='dashboard flex items-center gap-3'>
